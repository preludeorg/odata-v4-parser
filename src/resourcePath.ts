...
export function entity(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function collectionNavigation(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  const start = index;
  let name;
  if (value[index] === 0x2f) {
    name = NameOrIdentifier.qualifiedEntityTypeName(value, index + 1, metadataContext);
...
export function collectionNavigationPath(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  const start = index;
...
export function singleNavigation(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function propertyPath(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  const token =
...
export function collectionPath(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  return Expressions.countExpr(value, index) ||
    boundOperation(value, index, true, metadataContext);
}

export function singlePath(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  return Expressions.valueExpr(value, index) ||
    boundOperation(value, index, false, metadataContext);
}

export function complexPath(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
  const start = index;
  let name, token;
  if (value[index] === 0x2f) {
...
export function boundOperation(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundActionCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundFunctionCall(value: SourceArray, index: number, odataFunction: Function, tokenType: Lexer.TokenType, isCollection: boolean, metadataContext?: any): Lexer.Token {
  const namespaceNext = NameOrIdentifier.namespace(value, index);
  if (namespaceNext === index) { return; }
  const start = index;
  index = namespaceNext;
...
export function boundEntityFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundEntityColFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundComplexFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundComplexColFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundPrimitiveFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function boundPrimitiveColFuncCall(value: SourceArray, index: number, isCollection: boolean, metadataContext?: any): Lexer.Token {
...
export function actionImportCall(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function functionImportCall(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function functionParameters(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function functionParameter(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
...
export function crossjoin(value: SourceArray, index: number, metadataContext?: any): Lexer.Token {
