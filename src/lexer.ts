...
// punctuation
export function whitespaceLength(value: SourceArray, index: number) {
...
export function AT(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x40) {
    return index + 1;
...
export function COLON(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x3a) {
    return index + 1;
...
export function COMMA(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x2c) {
    return index + 1;
...
export function EQ(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x3d) {
    return index + 1;
  }
}
export function SIGN(value: SourceArray, index: number): number | undefined {
...
export function SEMI(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x3b) {
    return index + 1;
...
export function STAR(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x2a) {
    return index + 1;
...
export function SQUOTE(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x27) {
    return index + 1;
...
export function OPEN(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x28) {
    return index + 1;
...
export function CLOSE(value: SourceArray, index: number): number | undefined {
  if (value[index] === 0x29) {
    return index + 1;
...
// other-delims "!" /                   "(" / ")" / "*" / "+" / "," / ";"
export function otherDelims(value: SourceArray, index: number): number | undefined {
...
export function subDelims(value: SourceArray, index: number): number | undefined {
